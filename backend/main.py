...
from app.routes import health, profile, jobs, market, coach, charts, auth, user_router, progress, interview_router, interview_v2_router
...
app.include_router(interview_v2_router.router, prefix="/api")

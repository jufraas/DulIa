    ...
    >
      ...
      <div className="relative flex shrink-0 items-center gap-3">
        ...
        <div className="min-w-0 flex-1 text-white">
          ...
          <div className="mt-0.5 font-[family-name:var(--font-display)] text-[17px] font-extrabold leading-[1.2] tracking-[-0.02em] sm:text-[18px]">
      ...
      <div className="pdf-card-footer relative z-[1] mt-2.5 flex flex-wrap justify-center gap-3 text-[11px] font-medium text-white/85">

...
**Coach context-aware (B6):** el system prompt incluye progreso del plan y última entrevista si existen. `POST /progress/.../add-tasks-from-weak-skills` enriquece el plan desde resultados de entrevista.
